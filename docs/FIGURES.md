...
The file listed below shows the Precision Recall Curve at different cutoffs (`[5, 10, 15, 20, 30, 100, 200, 500, 1000]`). While the graph is a little bit more fine graned, nothing major changes in the shapes of the curves.
